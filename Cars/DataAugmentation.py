...
for img_name in image_files:
    ...
    tf.io.write_file(original_output_path, tf.io.encode_jpeg(image))
    ...
    tf.io.write_file(flipped_original_output_path, tf.io.encode_jpeg(flipped_original))
    ...
    for i in range(5):
        ...
        tf.io.write_file(rotated_output_path, tf.io.encode_jpeg(rotated_image))
        ...
        tf.io.write_file(flipped_rotated_output_path, tf.io.encode_jpeg(flipped_rotated_image))
