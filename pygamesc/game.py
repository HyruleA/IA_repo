...
def mostrar_menu():
    ...
    pantalla.fill(NEGRO)
    texto = fuente.render("Presiona 'A' para Auto, 'M' para Manual, 'G' para mostrar la Grafica o 'Q' para Salir", True, BLANCO)
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                if evento.key == pygame.K_a:
                    ...
                    print('Mostrando Grafica')
                    #mostrar(datos_modelo)
                elif evento.key == pygame.K_q:
                    print("Juego terminado. Datos recopilados:", datos_modelo)
                    with open ('phaser.csv', 'a') as datos:
                        datos.write(str(datos_modelo))
                    pygame.quit()
                    exit()
